 ...
 * due date:
 */
public class ConditionalHarvester extends Harvester
{
    public ConditionalHarvester(int st, int av, Direction dir, int numBeepers) {
        super(st, av, dir, numBeepers);
    }
    public void harvestCorner() {
        //Picks up a beeper on a given corner if a beeper present
        if (nextToABeeper()) {
            pickBeeper();
        }
    }
    //New methods available in Robot class
